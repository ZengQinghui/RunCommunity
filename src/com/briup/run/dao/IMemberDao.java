...
public interface IMemberDao {
	...
	Pointaction findPointactionByPointAction(String actionName)throws DataAccessException;
	...
	void updateSpace(Memberspace memberspace) throws DataAccessException;
	...
	//删除黑名单会员
	void deleteBlack(Blackrecord black) throws DataAccessException;
