...
public interface IMemberService {
	...
	// 登出
	void logout(String nickname) throws MemberServiceException, DataAccessException;
	...
	// 查找好友
	Friendrecord findFriend(String selfname,String friendName) throws MemberServiceException;
	...
	// 修改个人空间
	void updateSpace(Memberspace memberspace) throws MemberServiceException;
