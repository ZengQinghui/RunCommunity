			...
			<div id="header">
				...
				<div id="mainnav">
					<ul>
						...
						<li><a href="musicrun">音乐跑不停</a></li>
						<li><a href="equip">跑步装备库</a></li>
						<li><a href="guide">专业跑步指南</a></li>
						<li><a href="bbs">跑步论坛</a></li>
				...
				<div id="center">
					...
					<table width="600" border="0" align="center" cellpadding="0"
						...
						<tbody>
							<tr>
								<td width="100%">
									<form action="findFriends" method="post" name="matchFriendForm">
										<table width="100%" cellspacing="1" cellpadding="3"
											align="center">
											<tr>
												<td colspan="4"><b>找到您跑步世界的另一半，您可以 <a
														href="randomMatchFriend"><FONT color=#ff0000>马上速配</FONT></a>
														一位跑友
												</b></td>
											</tr>
											<tr>
						...
						<table width="100%" cellspacing="1" cellpadding="3" align="center">
							<tfoot>
								<c:forEach items="${friends}" var="c">
									<tr height="25">
										<td width="15%" align="center">${c.nickname}</td>
										<td width="15%" align="center">${c.gender}</td>
										<td width="15%" align="center">${c.age}</td>
										<td width="15%" align="center">${c.provincecity}</td>
										<td width="20%" align="center"><a href="addFriend?friendName=${c.nickname}">添加好友</a></td>
										<td width="20%" align="center"><a href="sendInfo?receiverName=${c.nickname}">发送短信</a></td>
									</tr>
								</c:forEach>
							</tfoot>
						</table>
					...
					<div id="hots">
						...
						<ul>
							<li>
								<div>
									<img src="./images/a.gif" /> <a href="modify">基本信息</a>
									<p>可修改自己的基本信息</p>
								</div>
							</li>
							<li>
								<div>
									<img src="./images/b.gif" /> <a href="inbox">我的信箱</a>
									<p>写信息、收件箱、发件箱</p>
								</div>
							</li>
							<li>
								<div>
									<img src="./images/c.gif" /> <a href="buddyList">我的好友</a>
									<p>好友管理及黑名单</p>
								</div>
							</li>
							<li>
								<div>
									<img src="./images/d.gif" /> <a href="space">个性空间</a>
									<p>创建自己的个性空间</p>
								</div>
							</li>
						</ul>
