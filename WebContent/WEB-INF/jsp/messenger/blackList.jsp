...
<script type="text/javascript">
		...
		function delBuddy(){
			...
			document.forms.blackListForm.action="deleteBlack";
		document.forms.blackListForm.submit();
	}
</script>
</head>
							...
							<tr>
								<td colspan="2" width="100%">
									<table width="100%">
										...
										<tbody>
											<c:forEach items="${blackList}" var="c">
												<tr>
													<th width="10%" align="center"><input type="checkbox"
														name="nickName" value="${c.nickname}" /></th>
													<td width="20%" align="center">${c.nickname}</td>
													<td width="20%" align="center">${c.gender}</td>
													<td width="20%" align="center">${c.age}</td>
													<td width="20%" align="center">${c.provincecity}</td>
													<td width="10%" align="center"><img
														src="./images/button_delete.gif" alt="移动好友名单"
														onclick="window.location='moveToFriend?blackName=${c.nickname}'"
