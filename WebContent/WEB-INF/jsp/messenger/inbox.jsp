...
<script type="text/javascript">
			function delMessage(){
				...
				document.forms.inboxForm.action="delRecieveMessage";
		...
		document.forms.inboxForm.action="view";
		document.forms.inboxForm.submit();
	}
</script>
</head>
							...
							<tr>
								...
								<td width="100%" colspan="2">
									<table width="100%">
										...
										<tbody>
											<c:forEach items="${recieveMessages }" var="c">
												<tr>
													<td width="10%"><input type="checkbox" name="ID"
														value="${c.id }" /></td>
													<td width="20%"><a href="view?ID=${c.id }">${c.title }</a></td>
													<td width="20%">${c.sender }</td>
													<td width="30%">${c.senddate }</td>
													<td><img src="${c.status }" /></td>
												</tr>
											</c:forEach>
										</tbody>
