						...
						<tr>
							<td width="100%">
								<form action="doModify" method="post"
									onSubmit="return validateModifyForm(this);">
										...
										<tbody>
											<tr>
												...
												<td width="30%"><input type="text" maxLength="14"
													style="width: 200px" name="nickName" disabled /></td>
											...
											<tr>
												...
												<td><input type="text" maxLength="30"
													style="width: 200px" name="email" /></td>
