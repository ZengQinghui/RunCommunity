		...
		<div id="main">
			...
			<div id="header">
				...
				<div id="mainnav">
					...
					<span>
						<form action="doLogin" method="post" id="login" onsubmit="checkLoginForm(this); ">
							<table width="100%">
								<tr>
									...
									<td><a href="register">如何注册</a> ｜ <a
										href="findPassword"> 忘记密码</a></td>
								</tr>
							</table>
						</form>
					</span>
			...
			<div id="content">
				...
				<div id="left">
					...
					<div id="hots">
						...
						<ul>
							<li>
								<div>
									<img src="images/a.gif" /> <a href="index">基本信息</a>
									<p>可修改自己的基本信息</p>
								</div>
							</li>
							<li>
								<div>
									<img src="images/b.gif" /> <a href="index">我的信箱</a>
									<p>写信息、收件箱、发件箱</p>
								</div>
							</li>
							<li>
							...
							<li>
								<div>
									<img src="images/d.gif" /> <a href="index">个性空间</a>
									<p>创建自己的个性空间</p>
								</div>
							</li>
						</ul>
				...
				<div id="right">
					<table width="300">
						<tr>
							<td align="left">您是本社区的第${count }位来访者</td>
						</tr>
					...
					<h2>积分排行榜</h2>
					<ul>
					<c:forEach items="${memberinfoByNum }" var="c">
						<li><a href="index">${c.nickname }</a></li>
					</c:forEach>
					</ul>
				</div>
				<div class="clear"></div>
